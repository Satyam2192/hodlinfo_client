...
function Row(props) {
  var className = props.className, cssModule = props.cssModule, noGutters = props.noGutters, Tag = props.tag, widths = props.widths, attributes = _objectWithoutProperties2(props, _excluded2);
  var colClasses = [];
...
function Col(props) {
  var className = props.className, cssModule = props.cssModule, widths = props.widths, Tag = props.tag, attributes = _objectWithoutProperties3(props, _excluded3);
...
function Navbar(props) {
  var _classNames;
  var expand = props.expand, className = props.className, cssModule = props.cssModule, light = props.light, dark = props.dark, fixed = props.fixed, sticky = props.sticky, color = props.color, container = props.container, Tag = props.tag, children2 = props.children, attributes = _objectWithoutProperties4(props, _excluded4);
...
function NavbarBrand(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties5(props, _excluded5);
...
function NavbarText(props) {
  var className = props.className, cssModule = props.cssModule, active = props.active, Tag = props.tag, attributes = _objectWithoutProperties6(props, _excluded6);
...
function NavbarToggler(props) {
  var className = props.className, cssModule = props.cssModule, children2 = props.children, Tag = props.tag, attributes = _objectWithoutProperties7(props, _excluded7);
...
function Nav(props) {
  var className = props.className, cssModule = props.cssModule, tabs = props.tabs, pills = props.pills, vertical = props.vertical, horizontal = props.horizontal, justified = props.justified, fill = props.fill, navbar = props.navbar, card = props.card, Tag = props.tag, attributes = _objectWithoutProperties8(props, _excluded8);
...
function NavItem(props) {
  var className = props.className, cssModule = props.cssModule, active = props.active, Tag = props.tag, attributes = _objectWithoutProperties9(props, _excluded9);
...
var NavLink = function(_React$Component) {
  ...
  _createClass(NavLink2, [{
    ...
    value: function render() {
      var _this$props = this.props, className = _this$props.className, cssModule = _this$props.cssModule, active = _this$props.active, Tag = _this$props.tag, innerRef = _this$props.innerRef, attributes = _objectWithoutProperties10(_this$props, _excluded10);
...
function Breadcrumb(props) {
  var className = props.className, listClassName = props.listClassName, cssModule = props.cssModule, children2 = props.children, Tag = props.tag, ListTag = props.listTag, label = props["aria-label"], attributes = _objectWithoutProperties11(props, _excluded11);
...
function BreadcrumbItem(props) {
  var className = props.className, cssModule = props.cssModule, active = props.active, Tag = props.tag, attributes = _objectWithoutProperties12(props, _excluded12);
...
CloseButton.defaultProps = defaultProps13;
...
function Button(props) {
  ...
  var active = props.active, ariaLabel = props["aria-label"], block = props.block, className = props.className, close = props.close, cssModule = props.cssModule, color = props.color, outline = props.outline, size = props.size, Tag = props.tag, innerRef = props.innerRef, attributes = _objectWithoutProperties14(props, _excluded14);
  if (close) {
...
function ButtonToggle(props) {
  var _useState = (0, import_react15.useState)(props.defaultValue), _useState2 = _slicedToArray(_useState, 2), toggled = _useState2[0], setToggled = _useState2[1];
...
ButtonToggle.defaultProps = defaultProps15;
...
var Dropdown = function(_React$Component) {
  ...
  _createClass2(Dropdown2, [{
    ...
    value: function render() {
      ...
      return import_react18.default.createElement(DropdownContext.Provider, {
        value: this.getContextValue()
      }, import_react18.default.createElement(Manager, null, import_react18.default.createElement(Tag, _extends16({}, attrs, _defineProperty3({}, typeof Tag === "string" ? "ref" : "innerRef", this.containerRef), {
...
Dropdown.defaultProps = defaultProps16;
...
function ButtonGroup(props) {
  var className = props.className, cssModule = props.cssModule, size = props.size, vertical = props.vertical, Tag = props.tag, attributes = _objectWithoutProperties17(props, _excluded17);
  ...
  return import_react20.default.createElement(Tag, _extends18({}, attributes, {
    className: classes
  }));
}
ButtonGroup.propTypes = propTypes18;
ButtonGroup.defaultProps = defaultProps17;
...
function ButtonToolbar(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties18(props, _excluded18);
  var classes = mapToCssModules((0, import_classnames18.default)(className, "btn-toolbar"), cssModule);
  return import_react21.default.createElement(Tag, _extends19({}, attributes, {
    className: classes
  }));
}
ButtonToolbar.propTypes = propTypes19;
ButtonToolbar.defaultProps = defaultProps18;
...
var DropdownItem = function(_React$Component) {
  ...
  _createClass3(DropdownItem2, [{
    ...
    value: function render() {
      ...
      var _omit = omit(this.props, ["toggle"]), className = _omit.className, cssModule = _omit.cssModule, divider = _omit.divider, Tag = _omit.tag, header = _omit.header, active = _omit.active, text = _omit.text, props = _objectWithoutProperties19(_omit, _excluded19);
...
DropdownItem.defaultProps = defaultProps19;
...
DropdownMenu.defaultProps = defaultProps20;
  ...
  _createClass5(DropdownToggle2, [{
    ...
    value: function render() {
      ...
      return import_react24.default.createElement(Reference, {
        ...
        return import_react24.default.createElement(Tag, _extends22({}, props, _defineProperty5({}, typeof Tag === "string" ? "ref" : "innerRef", handleRef), {
          className: classes,
...
DropdownToggle.defaultProps = defaultProps21;
...
TransitionGroup.defaultProps = defaultProps22;
...
var propTypes23 = _objectSpread2(_objectSpread2({}, Transition_default.propTypes), {}, {
...
var defaultProps23 = _objectSpread2(_objectSpread2({}, Transition_default.defaultProps), {}, {
  tag: "div",
  baseClass: "fade",
...
function Fade(props) {
  ...
  var Tag = props.tag, baseClass = props.baseClass, baseClassActive = props.baseClassActive, className = props.className, cssModule = props.cssModule, children2 = props.children, _props$innerRef = props.innerRef, innerRef = _props$innerRef === void 0 ? ref : _props$innerRef, otherProps = _objectWithoutProperties22(props, _excluded22);
...
Fade.defaultProps = defaultProps23;
...
function Accordion(props) {
  var flush = props.flush, open = props.open, toggle2 = props.toggle, className = props.className, cssModule = props.cssModule, Tag = props.tag, innerRef = props.innerRef, attributes = _objectWithoutProperties23(props, _excluded23);
...
Accordion.defaultProps = defaultProps24;
...
function UncontrolledAccordion(_ref) {
  ...
  return import_react35.default.createElement(Accordion_default, _extends26({}, props, {
    open,
    toggle: toggle2
  }));
}
UncontrolledAccordion.propTypes = propTypes25;
UncontrolledAccordion.defaultProps = defaultProps25;
...
function AccordionHeader(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, innerRef = props.innerRef, children2 = props.children, targetId = props.targetId, attributes = _objectWithoutProperties25(props, _excluded25);
...
AccordionHeader.defaultProps = defaultProps26;
...
function AccordionItem(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, innerRef = props.innerRef, attributes = _objectWithoutProperties26(props, _excluded26);
...
AccordionItem.defaultProps = defaultProps27;
...
var propTypes28 = _objectSpread3(_objectSpread3({}, Transition_default.propTypes), {}, {
...
var defaultProps28 = _objectSpread3(_objectSpread3({}, Transition_default.defaultProps), {}, {
  horizontal: false,
  isOpen: false,
  appear: false,
  enter: true,
...
var transitionStatusToClassHash = (_transitionStatusToCl = {}, _defineProperty7(_transitionStatusToCl, TransitionStatuses.ENTERING, "collapsing"), _defineProperty7(_transitionStatusToCl, TransitionStatuses.ENTERED, "collapse show"), _defineProperty7(_transitionStatusToCl, TransitionStatuses.EXITING, "collapsing"), _defineProperty7(_transitionStatusToCl, TransitionStatuses.EXITED, "collapse"), _transitionStatusToCl);
  ...
  _createClass6(Collapse2, [{
    ...
    value: function render() {
      ...
      return import_react38.default.createElement(Transition_default, _extends29({}, transitionProps, {
        ...
        var style = dimension === null ? null : _defineProperty7({}, horizontal ? "width" : "height", dimension);
        return import_react38.default.createElement(Tag, _extends29({}, childProps, {
          style: _objectSpread3(_objectSpread3({}, childProps.style), style),
          className: classes,
          ref: _this2.nodeRef
        }), children2);
      });
...
Collapse.defaultProps = defaultProps28;
...
function AccordionBody(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, innerRef = props.innerRef, children2 = props.children, accordionId = props.accordionId, attributes = _objectWithoutProperties28(props, _excluded28);
...
AccordionBody.defaultProps = defaultProps29;
...
function Badge(props) {
  var className = props.className, cssModule = props.cssModule, color = props.color, innerRef = props.innerRef, pill = props.pill, Tag = props.tag, attributes = _objectWithoutProperties29(props, _excluded29);
...
Badge.defaultProps = defaultProps30;
...
function Card(props) {
  var className = props.className, cssModule = props.cssModule, color = props.color, body = props.body, inverse = props.inverse, outline = props.outline, Tag = props.tag, innerRef = props.innerRef, attributes = _objectWithoutProperties30(props, _excluded30);
...
Card.defaultProps = defaultProps31;
...
function CardGroup(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties31(props, _excluded31);
...
CardGroup.defaultProps = defaultProps32;
...
function CardDeck(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties32(props, _excluded32);
...
CardDeck.defaultProps = defaultProps33;
...
function CardColumns(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties33(props, _excluded33);
...
CardColumns.defaultProps = defaultProps34;
...
function CardBody(props) {
  var className = props.className, cssModule = props.cssModule, innerRef = props.innerRef, Tag = props.tag, attributes = _objectWithoutProperties34(props, _excluded34);
...
CardBody.defaultProps = defaultProps35;
...
function CardLink(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, innerRef = props.innerRef, attributes = _objectWithoutProperties35(props, _excluded35);
...
CardLink.defaultProps = defaultProps36;
...
function CardFooter(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties36(props, _excluded36);
...
CardFooter.defaultProps = defaultProps37;
...
function CardHeader(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties37(props, _excluded37);
...
CardHeader.defaultProps = defaultProps38;
...
function CardImg(props) {
  var className = props.className, cssModule = props.cssModule, top2 = props.top, bottom2 = props.bottom, Tag = props.tag, attributes = _objectWithoutProperties38(props, _excluded38);
...
CardImg.defaultProps = defaultProps39;
...
function CardImgOverlay(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties39(props, _excluded39);
...
CardImgOverlay.defaultProps = defaultProps40;
...
var CarouselItem = function(_React$Component) {
  ...
  _createClass7(CarouselItem2, [{
    ...
    value: function render() {
      var _this2 = this;
      var _this$props = this.props, isIn = _this$props["in"], children2 = _this$props.children, cssModule = _this$props.cssModule, slide = _this$props.slide, Tag = _this$props.tag, className = _this$props.className, transitionProps = _objectWithoutProperties40(_this$props, _excluded40);
...
CarouselItem.propTypes = _objectSpread4(_objectSpread4({}, Transition_default.propTypes), {}, {
  /** Set a custom element for this component */
  tag: tagPropType,
...
CarouselItem.defaultProps = _objectSpread4(_objectSpread4({}, Transition_default.defaultProps), {}, {
  tag: "div",
...
Carousel.defaultProps = defaultProps41;
...
var UncontrolledCarousel = function(_Component) {
  ...
  _createClass9(UncontrolledCarousel2, [{
    ...
    value: function render() {
      var _this4 = this;
      var _this$props = this.props, defaultActiveIndex = _this$props.defaultActiveIndex, autoPlay = _this$props.autoPlay, indicators = _this$props.indicators, controls = _this$props.controls, items = _this$props.items, goToIndex = _this$props.goToIndex, props = _objectWithoutProperties43(_this$props, _excluded43);
...
function CardSubtitle(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties44(props, _excluded44);
...
CardSubtitle.defaultProps = defaultProps42;
...
function CardText(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties45(props, _excluded45);
...
CardText.defaultProps = defaultProps43;
...
function CardTitle(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties46(props, _excluded46);
...
CardTitle.defaultProps = defaultProps44;
...
var defaultProps45 = {
  ...
  onClosed: noop2,
  fade: true,
  transition: _objectSpread5({}, Fade_default.defaultProps)
};
var PopperContent = function(_React$Component) {
  ...
  _createClass10(PopperContent2, [{
    ...
    value: function renderChildren() {
      ...
      var popperTransition = _objectSpread5(_objectSpread5(_objectSpread5({}, Fade_default.defaultProps), transition), {}, {
...
PopperContent.defaultProps = defaultProps45;
...
TooltipPopoverWrapper.defaultProps = defaultProps46;
...
Popover.defaultProps = defaultProps47;
...
UncontrolledPopover.propTypes = _objectSpread6({
...
function PopoverHeader(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties48(props, _excluded48);
...
PopoverHeader.defaultProps = defaultProps48;
...
function PopoverBody(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties49(props, _excluded49);
...
PopoverBody.defaultProps = defaultProps49;
...
function Progress(props) {
  ...
  var progressBarProps = {
    ...
    style: _objectSpread7(_objectSpread7(_objectSpread7({}, bar ? style : {}), barStyle), {}, {
...
Progress.defaultProps = defaultProps50;
  ...
  _createClass14(Modal2, [{
    ...
    value: function renderModalDialog() {
      ...
      return import_react69.default.createElement("div", _extends57({}, attributes, {
        className: mapToCssModules((0, import_classnames52.default)(dialogBaseClass, this.props.className, (_classNames = {}, _defineProperty12(_classNames, "modal-".concat(this.props.size), this.props.size), _defineProperty12(_classNames, "".concat(dialogBaseClass, "-centered"), this.props.centered), _defineProperty12(_classNames, "".concat(dialogBaseClass, "-scrollable"), this.props.scrollable), _defineProperty12(_classNames, "modal-fullscreen", this.props.fullscreen === true), _defineProperty12(_classNames, "modal-fullscreen-".concat(this.props.fullscreen, "-down"), typeof this.props.fullscreen === "string"), _classNames)), this.props.cssModule),
        role: "document",
        ref: function ref(c) {
          _this3._dialog = c;
        }
    ...
    value: function render() {
      ...
      if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
        ...
        var modalTransition = _objectSpread8(_objectSpread8(_objectSpread8({}, Fade_default.defaultProps), this.props.modalTransition), {}, {
          baseClass: hasTransition ? this.props.modalTransition.baseClass : "",
          timeout: hasTransition ? this.props.modalTransition.timeout : 0
        });
        var backdropTransition = _objectSpread8(_objectSpread8(_objectSpread8({}, Fade_default.defaultProps), this.props.backdropTransition), {}, {
...
Modal.defaultProps = defaultProps51;
Modal.openCount = 0;
...
function ModalHeader(props) {
  var closeButton;
  var className = props.className, cssModule = props.cssModule, children2 = props.children, toggle2 = props.toggle, Tag = props.tag, WrapTag = props.wrapTag, closeAriaLabel = props.closeAriaLabel, close = props.close, attributes = _objectWithoutProperties51(props, _excluded51);
...
ModalHeader.defaultProps = defaultProps52;
...
function ModalBody(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties52(props, _excluded52);
...
ModalBody.defaultProps = defaultProps53;
...
function ModalFooter(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties53(props, _excluded53);
...
ModalFooter.defaultProps = defaultProps54;
...
Tooltip.defaultProps = defaultProps55;
...
function Table(props) {
  var className = props.className, cssModule = props.cssModule, size = props.size, bordered = props.bordered, borderless = props.borderless, striped = props.striped, dark = props.dark, hover = props.hover, responsive = props.responsive, Tag = props.tag, ResponsiveTag = props.responsiveTag, innerRef = props.innerRef, attributes = _objectWithoutProperties54(props, _excluded54);
...
Table.defaultProps = defaultProps56;
...
function ListGroup(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, flush = props.flush, horizontal = props.horizontal, numbered = props.numbered, attributes = _objectWithoutProperties55(props, _excluded55);
...
ListGroup.defaultProps = defaultProps57;
...
var Form = function(_Component) {
  ...
  _createClass15(Form2, [{
    ...
    key: "render",
    value: function render() {
      var _this$props = this.props, className = _this$props.className, cssModule = _this$props.cssModule, Tag = _this$props.tag, innerRef = _this$props.innerRef, attributes = _objectWithoutProperties56(_this$props, _excluded56);
...
Form.defaultProps = defaultProps58;
...
function FormFeedback(props) {
  var className = props.className, cssModule = props.cssModule, valid = props.valid, tooltip = props.tooltip, Tag = props.tag, attributes = _objectWithoutProperties57(props, _excluded57);
...
FormFeedback.defaultProps = defaultProps59;
...
function FormGroup(props) {
  var className = props.className, cssModule = props.cssModule, row = props.row, disabled = props.disabled, check = props.check, inline = props.inline, floating = props.floating, Tag = props.tag, switchProp = props["switch"], attributes = _objectWithoutProperties58(props, _excluded58);
...
FormGroup.defaultProps = defaultProps60;
...
function FormText(props) {
  var className = props.className, cssModule = props.cssModule, inline = props.inline, color = props.color, Tag = props.tag, attributes = _objectWithoutProperties59(props, _excluded59);
...
FormText.defaultProps = defaultProps61;
...
var Input = function(_React$Component) {
  ...
  _createClass16(Input2, [{
    ...
    key: "render",
    value: function render() {
      var _this$props = this.props, className = _this$props.className, cssModule = _this$props.cssModule, type = _this$props.type, bsSize = _this$props.bsSize, valid = _this$props.valid, invalid = _this$props.invalid, tag = _this$props.tag, addon = _this$props.addon, plaintext = _this$props.plaintext, innerRef = _this$props.innerRef, attributes = _objectWithoutProperties60(_this$props, _excluded60);
...
Input.defaultProps = defaultProps62;
...
function InputGroup(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, type = props.type, size = props.size, attributes = _objectWithoutProperties61(props, _excluded61);
...
InputGroup.defaultProps = defaultProps63;
...
function InputGroupText(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties62(props, _excluded62);
...
InputGroupText.defaultProps = defaultProps64;
...
function Label(props) {
  var className = props.className, cssModule = props.cssModule, hidden = props.hidden, widths = props.widths, Tag = props.tag, check = props.check, size = props.size, htmlFor = props["for"], attributes = _objectWithoutProperties63(props, _excluded63);
  var colClasses = [];
  widths.forEach(function(colWidth, i) {
    ...
    if (isObject(columnProp)) {
      ...
      colClasses.push(mapToCssModules((0, import_classnames65.default)((_classNames = {}, _defineProperty13(_classNames, colClass, columnProp.size || columnProp.size === ""), _defineProperty13(_classNames, "order".concat(colSizeInterfix).concat(columnProp.order), columnProp.order || columnProp.order === 0), _defineProperty13(_classNames, "offset".concat(colSizeInterfix).concat(columnProp.offset), columnProp.offset || columnProp.offset === 0), _classNames))), cssModule);
    } else {
...
Label.defaultProps = defaultProps65;
  ...
  _createClass17(Offcanvas2, [{
    ...
    value: function render() {
      ...
      if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
        ...
        var hasTransition = this.props.fade;
        var offcanvasTransition = _objectSpread9(_objectSpread9(_objectSpread9({}, Fade_default.defaultProps), this.props.offcanvasTransition), {}, {
        ...
        var backdropTransition = _objectSpread9(_objectSpread9(_objectSpread9({}, Fade_default.defaultProps), this.props.backdropTransition), {}, {
          baseClass: hasTransition ? this.props.backdropTransition.baseClass : "",
          timeout: hasTransition ? this.props.backdropTransition.timeout : 0
        });
...
Offcanvas.defaultProps = defaultProps66;
...
function OffcanvasBody(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties65(props, _excluded65);
...
OffcanvasBody.defaultProps = defaultProps67;
...
function OffcanvasHeader(props) {
  var closeButton;
  var children2 = props.children, className = props.className, close = props.close, closeAriaLabel = props.closeAriaLabel, cssModule = props.cssModule, Tag = props.tag, toggle2 = props.toggle, WrapTag = props.wrapTag, attributes = _objectWithoutProperties66(props, _excluded66);
...
OffcanvasHeader.defaultProps = defaultProps68;
...
function Pagination(props) {
  var className = props.className, listClassName = props.listClassName, cssModule = props.cssModule, size = props.size, Tag = props.tag, ListTag = props.listTag, label = props["aria-label"], attributes = _objectWithoutProperties67(props, _excluded67);
  var classes = mapToCssModules((0, import_classnames70.default)(className), cssModule);
  var listClasses = mapToCssModules((0, import_classnames70.default)(listClassName, "pagination", _defineProperty15({}, "pagination-".concat(size), !!size)), cssModule);
...
Pagination.defaultProps = defaultProps69;
...
function PaginationItem(props) {
  var active = props.active, className = props.className, cssModule = props.cssModule, disabled = props.disabled, Tag = props.tag, attributes = _objectWithoutProperties68(props, _excluded68);
...
PaginationItem.defaultProps = defaultProps70;
...
function PaginationLink(props) {
  var className = props.className, cssModule = props.cssModule, next = props.next, previous = props.previous, first = props.first, last = props.last, Tag = props.tag, attributes = _objectWithoutProperties69(props, _excluded69);
...
PaginationLink.defaultProps = defaultProps71;
...
TabContent.defaultProps = defaultProps72;
...
function TabPane(props) {
  var className = props.className, cssModule = props.cssModule, tabId = props.tabId, Tag = props.tag, attributes = _objectWithoutProperties70(props, _excluded70);
...
TabPane.defaultProps = defaultProps73;
...
var defaultProps74 = {
  ...
  closeAriaLabel: "Close",
  fade: true,
  transition: _objectSpread10(_objectSpread10({}, Fade_default.defaultProps), {}, {
    unmountOnExit: true
  })
};
function Alert(props) {
  var className = props.className, closeClassName = props.closeClassName, closeAriaLabel = props.closeAriaLabel, cssModule = props.cssModule, Tag = props.tag, color = props.color, isOpen = props.isOpen, toggle2 = props.toggle, children2 = props.children, transition = props.transition, fade = props.fade, innerRef = props.innerRef, attributes = _objectWithoutProperties71(props, _excluded71);
  ...
  var alertTransition = _objectSpread10(_objectSpread10(_objectSpread10({}, Fade_default.defaultProps), transition), {}, {
    baseClass: fade ? transition.baseClass : "",
    timeout: fade ? transition.timeout : 0
  });
...
Alert.defaultProps = defaultProps74;
...
var defaultProps75 = {
  ...
  tag: "div",
  fade: true,
  transition: _objectSpread11(_objectSpread11({}, Fade_default.defaultProps), {}, {
    unmountOnExit: true
  })
};
function Toast(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, isOpen = props.isOpen, children2 = props.children, transition = props.transition, fade = props.fade, innerRef = props.innerRef, attributes = _objectWithoutProperties72(props, _excluded72);
  var classes = mapToCssModules((0, import_classnames76.default)(className, "toast"), cssModule);
  var toastTransition = _objectSpread11(_objectSpread11(_objectSpread11({}, Fade_default.defaultProps), transition), {}, {
    baseClass: fade ? transition.baseClass : "",
    timeout: fade ? transition.timeout : 0
  });
...
Toast.defaultProps = defaultProps75;
...
function ToastBody(props) {
  var className = props.className, cssModule = props.cssModule, innerRef = props.innerRef, Tag = props.tag, attributes = _objectWithoutProperties73(props, _excluded73);
...
ToastBody.defaultProps = defaultProps76;
...
function ToastHeader(props) {
  var closeButton;
  var icon;
  var className = props.className, cssModule = props.cssModule, children2 = props.children, toggle2 = props.toggle, Tag = props.tag, WrapTag = props.wrapTag, closeAriaLabel = props.closeAriaLabel, close = props.close, tagClassName = props.tagClassName, iconProp = props.icon, attributes = _objectWithoutProperties74(props, _excluded74);
...
ToastHeader.defaultProps = defaultProps77;
...
function ListGroupItem(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, active = props.active, disabled = props.disabled, action = props.action, color = props.color, attributes = _objectWithoutProperties75(props, _excluded75);
...
ListGroupItem.defaultProps = defaultProps78;
...
function ListGroupItemHeading(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties76(props, _excluded76);
...
ListGroupItemHeading.defaultProps = defaultProps79;
...
function ListGroupItemText(props) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties77(props, _excluded77);
...
ListGroupItemText.defaultProps = defaultProps80;
...
var List = (0, import_react101.forwardRef)(function(props, ref) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, type = props.type, attributes = _objectWithoutProperties78(props, _excluded78);
...
List.defaultProps = defaultProps81;
...
var ListInlineItem = (0, import_react102.forwardRef)(function(props, ref) {
  var className = props.className, cssModule = props.cssModule, Tag = props.tag, attributes = _objectWithoutProperties79(props, _excluded79);
...
ListInlineItem.defaultProps = defaultProps82;
...
UncontrolledButtonDropdown.propTypes = _objectSpread12({
...
UncontrolledCollapse.defaultProps = defaultProps83;
...
UncontrolledDropdown.propTypes = _objectSpread13({
...
UncontrolledTooltip.propTypes = _objectSpread14({
...
function Spinner(props) {
  var className = props.className, cssModule = props.cssModule, type = props.type, size = props.size, color = props.color, children2 = props.children, Tag = props.tag, attributes = _objectWithoutProperties80(props, _excluded80);
...
Spinner.defaultProps = defaultProps84;
...
var propTypes86 = _objectSpread15(_objectSpread15({}, Col_default.propTypes), {}, {
  /** Add custom color to the placeholder */
...
function Placeholder(props) {
  var className = props.className, cssModule = props.cssModule, color = props.color, innerRef = props.innerRef, Tag = props.tag, animation = props.animation, size = props.size, widths = props.widths, attributes = _objectWithoutProperties81(props, _excluded81);
  var _getColumnClasses = getColumnClasses(attributes, cssModule, widths), modifiedAttributes = _getColumnClasses.modifiedAttributes, colClasses = _getColumnClasses.colClasses;
...
Placeholder.defaultProps = defaultProps85;
...
function PlaceholderButton(props) {
  var cssModule = props.cssModule, className = props.className, Tag = props.tag, attributes = _objectWithoutProperties82(props, _excluded82);
  ...
  return import_react110.default.createElement(Button_default, _extends97({}, modifiedAttributes, {
    className: classes,
    disabled: true
  }));
}
PlaceholderButton.propTypes = propTypes87;
PlaceholderButton.defaultProps = defaultProps86;
